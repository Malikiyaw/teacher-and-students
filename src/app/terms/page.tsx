    ...
    <>
      ...
      <div className="pt-32 pb-24 max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-charcoal space-y-6 text-sm text-charcoal/60 leading-relaxed">
          ...
          <p>ClassDeck is a presentation platform for students and teachers. Users can create and present slide decks with rich media, charts, code, and design tools. Presentations can be exported to PPTX, PDF, HTML, and PNG formats.</p>
          <h2 className="font-heading text-xl text-charcoal">Free Tier</h2>
          <p>The Starter plan is free and includes up to 5 presentations and basic templates.</p>
          <h2 className="font-heading text-xl text-charcoal">Pro Plan</h2>
          <p>The Pro plan costs $8/month per user and includes unlimited presentations, premium templates, advanced exports, and priority support.</p>
          <h2 className="font-heading text-xl text-charcoal">User Responsibilities</h2>
          <p>You are responsible for your account credentials and all activity under your account. Users are responsible for the content they create and share.</p>
