  ...
  return (
    <div className="w-full max-w-sm mx-auto">
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <button
          type="submit"
          className="w-full bg-charcoal text-white text-sm font-medium py-3 rounded-xl hover:bg-charcoal-light transition-all duration-300 cubic-bezier(0.25, 0.8, 0.25, 1) hover:shadow-lg hover:shadow-charcoal/10"
        >
          Log In
        </button>
      </form>
